            ...
            for j in range(len(board[0])):
                if board[i, j] == 1 or board[i, j] == 0:
                    for d in directions:
                        ...
                        if 0 <= ni < 5 and 0 <= nj < 5 and board[ni, nj] == 0 and board[i + d[0], j + d[1]] == 1:
                            moves.append(((i, j), (ni, nj)))
                        elif 0 <= ni < 5 and 0 <= nj < 5 and board[ni, nj] == 0 and board[i + d[0], j + d[1]] == 0:
                            moves.append(((i, j), (ni, nj)))
                        elif 0 <= ni < 5 and 0 <= nj < 5 and board[ni, nj] == 1 and board[i + d[0], j + d[1]] == 1:
                            moves.append(((i, j), (ni, nj)))
                        elif 0 <= ni < 5 and 0 <= nj < 5 and board[ni, nj] == 1 and board[i + d[0], j + d[1]] == 0:
                            moves.append(((i, j), (ni, nj)))
        return moves
